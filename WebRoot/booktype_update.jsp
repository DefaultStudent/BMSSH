...
<link href="CSS/style.css" rel="stylesheet">   
  ...
  <tr>
   ...
   <form name="form1" method="post" action="BookType_update">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
      
       <td height="50" align="center">  图书类型名称：
       <s:hidden name="booktype.booktypeid" value="%{#session.booktypeid}"></s:hidden>
       <s:textfield name="booktype.booktypename" value="%{#session.booktypename}"></s:textfield>
