      ...
      <tr>
        ...
        <td><table width="100%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <s:form name="form1" method="post" action="BookType_add" theme="simple">
                <table width="100%" height="114"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                 <td height="74" align="center">图书类型编号：
                      <input name="booktype.booktypeid" type="text"><br>
           
                        图书类型名称：
                      <input name="booktype.booktypename" type="text"></td>
                    </tr>
                  <tr>
